\subsection{Iterative Evaluation of Coding Agents}\label{sec:results}
...
\input{paper-includes/slopcodebench/sections/results/overall}
\input{paper-includes/slopcodebench/sections/results/quality_accumulation.tex}
\input{paper-includes/slopcodebench/sections/results/agent_vs_human.tex}
\input{paper-includes/slopcodebench/sections/results/prompt_strategies.tex}
