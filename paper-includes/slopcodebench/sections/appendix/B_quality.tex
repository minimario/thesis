...
\subsection{Quality and Erosion Analysis}\label{sec:appendix-quality}

\subsubsection{Code Quality Examples}\label{sec:appendix-quality-examples}
...
\subsubsection{Erosion Example: \texttt{forge/main} Across Eight Checkpoints}\label{sec:appendix-erosion-example}
...
\subsubsection{Erosion Sensitivity}\label{sec:erosion-sensitivity}
...
\input{paper-includes/slopcodebench/sections/generated/appendix_erosion_sensitivity_table}
