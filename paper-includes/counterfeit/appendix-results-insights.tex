\subsection{Correlations by Problem Difficulty}
\subsubsection{Problem Difficulty vs. Correctness Checking} \label{appendix:difficulty-correctness-full}
...
\subsubsection{Problem Difficulty vs. Execution} \label{appendix:difficulty-execution-full}
...
\clearpage
\subsubsection{HumanEval Pass Rate vs. Correctness Prediction}
