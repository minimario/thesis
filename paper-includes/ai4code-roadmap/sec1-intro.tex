...
of language models and reveal various insights about their behavior. In this section, we share several 
highlights from a roadmap paper we developed over a year ago that were shaped partially by the
lessons that we have learned from these evaluations~\cite{gu2025positionaiswe}.

Our goal is threefold. In Sec. \ref{sec:tasks-milestones}, we briefly summarize the
main task families in AI for software engineering, focusing on formal verification as
