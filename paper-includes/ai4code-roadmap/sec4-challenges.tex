...
The specific challenges and sub-challenges below are not meant to be an exhaustive list, but rather a 
reflection of a few themes that are inspired by the work we discussed this thesis.
