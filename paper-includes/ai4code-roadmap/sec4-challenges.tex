...
\begin{lstlisting}[caption={LLM-generated Lean code snippet that hallucinates a nonexistent function},label={lst:lean-hallucination}, captionpos=t, language=lean, breaklines=true, style=mystyle]
