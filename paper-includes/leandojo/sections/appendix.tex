...
\subsection{LeanDojo Technical Details}
...
\subsubsection{Extracting Premise Information from Lean's Elaborator}
...
\subsubsection{Reliable Interaction with Lean}
...
\subsubsection{Comparison with Existing Tools for Learning-Based Theorem Proving in Lean}
...
\input{paper-includes/leandojo/tables/comparison}
...
\subsubsection{Data Hosting, Licensing, and Maintenance}
...
\subsubsection{Details and Hyperparameters}
...
\subsubsection{The GPT-4 Baseline}
...
\subsubsection{Justifications for Not Comparing with Existing LLM-Based Provers}
...
\subsubsection{Evaluation on MiniF2F and ProofNet}
...
\subsection{LeanDojo for Lean 4}
...
\input{paper-includes/leandojo/tables/lean4_premise_selection_results}

\input{paper-includes/leandojo/tables/lean4_theorem_proving_results}

\subsection{ChatGPT Plugin for Theorem Proving}
