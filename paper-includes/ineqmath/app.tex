...
\vbox{
    ...
    \hspace{-0.5mm}Solving Inequality Proofs with Large Language Models}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip 0.29in
\vskip -\parskip
\hrule height 1pt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*\footnoterule{} % remove the separator line
...
\newpage
\subsection{Prompts for Rephrasing Problems}
\label{app:prompt_rephrasing_problem}

% Prompt for Rephrasing Problems
\input{prompts/proof_rewritten_bound}
\input{prompts/proof_rewritten_relation}
...
\input{src/testing_bound_examples_1}

\input{src/testing_bound_examples_2}

\input{src/testing_bound_examples_3}

\clearpage
\input{src/testing_relation_examples_1}

\input{src/testing_relation_examples_2}

\input{src/testing_relation_examples_3}


\clearpage
\section{Fine-grained Informal Judge Details}
\label{app:evaluation_details}

\subsection{Final Answer Judge}
\label{app:answer_judge_appendix}

\input{prompts/answer_judge_answer_extraction}

\input{prompts/answer_judge_answer_equivalence}

% \clearpage
\subsection{Toy Case Judge}
\label{app:toy_case_appendix}

\input{prompts/toy_case_judge}

\input{src/toy_case_judge_examples}


% \newpage
\subsection{Logical Gap Judge}
\label{app:logical_gap_appendix}

\input{prompts/logical_gap_judge}

\input{src/logical_gap_judge_example}

% \clearpage
\subsection{Numerical Approximation Judge}
\label{app:approximation_judge_appendix}

\input{prompts/approx_judge}
\input{src/numerical_approximation_judge_example}

% \newpage
\subsection{Numerical Computation Judge}
\label{app:computation_judge_appendix}

\input{prompts/computation_judge}

\input{src/computation_judge_example}

% \clearpage
\subsection{Development Performance of Judges}
\label{app:judge_dev_performance}


\input{src/table_models_performance_as_toy_cases_judge}
...
% \clearpage
\subsection{Judge Failure Examples}
\label{app:judge_failure_examples}

\input{src/failure_judge_example_1}

\input{src/failure_judge_example_2}

\input{src/failure_judge_example_3}

\input{src/failure_judge_example_4}

\clearpage
\section{Experimental Details for Inequality Solving}
...
\input{prompts/task_description}

\input{src/table_app_model_and_params}
...
\clearpage
\subsection{Model Failure Solution Examples}
\label{app:incorrect_solution_examples}


\subsubsection{Model Failure Solution Example 1}
\label{app:failure_solution_example_1}
\input{src/failure_solution_example_1}

\clearpage
\subsubsection{Model Failure Solution Example 2}
\label{app:failure_solution_example_2}
\input{src/failure_solution_example_2}

\clearpage
\subsubsection{Model Failure Solution Example 3}
\label{app:failure_solution_example_3}
\input{src/failure_solution_example_3}

\clearpage
\subsubsection{Model Failure Solution Example 4}
\label{app:failure_solution_example_4}
\input{src/failure_solution_example_4}

\clearpage
\subsubsection{Model Failure Solution Example 5}
\label{app:failure_solution_example_5}
\input{src/failure_solution_example_5}


\clearpage
\subsection{Taking Annotated Theorems as Hints}
...
\input{src/explore_theorem_as_hints_no_theorem_example}

% \clearpage
\subsection{Retrieval as Augmentation}
\label{app:explore_retrieve_relevant_theorem_as_hints}

\paragraph{Retrieving relevant theorems as hints.} 
...
\input{src/explore_retrieved_theorem_as_hints_example_no_theorem}

\paragraph{Retrieving training problems as demonstrations.} 
...
\input{src/explore_retrieved_solution_as_hints}

% \clearpage
\subsection{Self-improvement via Critic as Feedback}
...
\input{src/explore_self_improvement_example_no_critic}

% \clearpage
\subsection{Few-shot Evaluation} % Few-shot evaluation
...
% \clearpage
\subsection{Evaluation on the Formalized \dataset}
...
\input{src/table_formal_evaluation}
...
\input{src/memorization_probe_bound_example}
\input{src/memorization_probe_relation_example}
