\subsection{FOLIO Few-Shot Prompts}
...
\subsubsection{FOLIO, 1-shot (baseline)}
...
\subsubsection{FOLIO, 1-shot (scratchpad)}
...
\subsubsection{FOLIO, 1-shot (chain of thought)}
...
\subsubsection{FOLIO, 1-shot (neurosymbolic)} \label{sec:folio1shotexample}
\begin{lstlisting}[breaklines=true]
The following is a first-order logic (FOL) problem.
The problem is to determine whether the conclusion follows from the premises.
The premises are given in the form of a set of first-order logic sentences.
